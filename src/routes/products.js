...
const { listProducts, getProduct, createProduct, bulkCreateProducts, updateProduct, updateVariantStock, archiveProduct, toggleSignatureProduct } = require("../controllers/productsController");
...
router.post("/bulk", requireBrandAuth, bulkCreateProducts);
